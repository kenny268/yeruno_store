  ...
  return (
    <div className="flex flex-col items-center p-24 md:p-28  w-full justify-center ">
      <form className='bg-slate-200 w-80  max-auto p-4 h-60 flex flex-col justify-evenly items-center rounded-sm shadow-md'>
        <h1 className='text-2xl text-center text'>Signin</h1>
        <input
          type="email"
          name="email"
        ...
        <button type="submit" className='p-2 bg-blue-600 shadow-lg text-xl rounded-lg w-1/2 items-center text-white'>Submit</button>      
    </form>
    </div>
  )
}
